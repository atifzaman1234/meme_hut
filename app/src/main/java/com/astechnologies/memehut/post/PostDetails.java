package com.astechnologies.memehut.post;
...
import com.astechnologies.memehut.adapter.AdapterComments;
import com.astechnologies.memehut.groups.ShareGroupActivity;
import com.astechnologies.memehut.model.ModelComments;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.astechnologies.memehut.fileprovider", file);
