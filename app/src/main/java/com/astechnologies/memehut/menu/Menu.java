package com.astechnologies.memehut.menu;
...
import com.astechnologies.memehut.user.MyFollowing;
import com.astechnologies.memehut.welcome.IntroLast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "Meme Hut - A home to all memes" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.astechnologies.memehut";
