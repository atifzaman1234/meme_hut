package com.astechnologies.memehut.shareChat;
...
import com.astechnologies.memehut.adapter.AdapterChat;
import com.astechnologies.memehut.MainActivity;
import com.astechnologies.memehut.model.ModelChat;
import com.astechnologies.memehut.model.ModelUser;
import com.astechnologies.memehut.R;
import com.astechnologies.memehut.SharedPref;
import com.astechnologies.memehut.notifications.Data;
import com.astechnologies.memehut.notifications.Sender;
import com.astechnologies.memehut.notifications.Token;
import com.astechnologies.memehut.user.UserProfile;
import com.astechnologies.memehut.welcome.GetTimeAgo;
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", jsonObject, new Response.Listener<JSONObject>() {
                            ...
                            public Map<String, String> getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", " AAAA7ikYBxk:APA91bF31v1CXUxmE1t7GMuS0H1puLGe8-HMStkz6P8kB2ydzHP1zu0zXYKlb4M5gGISSaTm56M6N6CmUEAbDoGYBODORxHbcEBlGF7FiysJmD63xJeVtaFNAw1uOK4_OcDK6BbLLEcD");
                                return headers;
                            }
                        };
